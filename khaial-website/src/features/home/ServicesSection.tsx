...
const ServicesSection = () => {
  ...
  const services: Service[] = [
    {
      title: t("homeServices.items.0.title"),
      description: t("homeServices.items.0.desc"),
      icon: (
        <IconShell>
          <AgentIcon />
        </IconShell>
    ...
    {
      title: t("homeServices.items.1.title"),
      description: t("homeServices.items.1.desc"),
      icon: (
        <IconShell>
          <SupportIcon />
        </IconShell>
    ...
    {
      title: t("homeServices.items.2.title"),
      description: t("homeServices.items.2.desc"),
      icon: (
        <IconShell>
          <MegaphoneIcon />
        </IconShell>
  ...
  const handleSeeItInAction = () => {
    ...
    router.push(`/${locale}/whatsapp`);
  };

  return (
    <section
      className="relative isolate overflow-hidden mx-auto mt-24 md:mt-32 w-full max-w-7xl px-6 py-24 sm:py-32 scroll-mt-24 mb-24 sm:mb-32"
    ...
    >
      ...
      <h2
        ...
        aria-label={t("whatsappServices.heading")}
      >
      ...
      <div className="mt-10 rounded-3xl border border-white/[0.08] bg-gradient-to-b from-white/[0.04] to-white/[0.01] p-6 md:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.3)] backdrop-blur-sm">
        <div className={`grid grid-cols-1 gap-6 md:gap-8 md:grid-cols-2 lg:grid-cols-3 mx-auto md:max-w-3xl lg:max-w-none ${isRTL ? "[direction:rtl]" : ""}`}>
            ...
            >
              ...
              <div className="relative flex h-full flex-col">
                ...
                <button
                  ...
                  className="mt-6 inline-flex items-center gap-2 rounded-xl border border-white/15 bg-white/10 px-3 py-2 text-xs font-medium text-white/90 transition-colors hover:bg-white/20 focus:outline-none focus:ring-2 ring-brand"
