...
const Navbar = () => {
  ...
  return (
    <header
      className={[
        "fixed inset-x-0 top-0 z-50 border-b border-[var(--k-border)]/30 transition-all duration-300 bg-transparent",
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3 md:hidden">
              ...
              <button
                ...
                className="inline-flex h-11 w-11 items-center justify-center rounded-lg border border-[var(--k-border)]/60 text-white/80 transition-colors focus:outline-none focus:ring-2 ring-brand"
              >
