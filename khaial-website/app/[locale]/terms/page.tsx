    ...
    <Layout>
      <main className="max-w-4xl mx-auto px-6 py-12">
        <article className="prose prose-invert">
          <p>Terms and Conditions for Khaial AI</p>
          ...
          <ul>
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Khaial AI.</li>
            ...
            <li><strong>Website</strong> refers to Khaial AI, accessible from <a href="https://www.khaial.ai" target="_blank" rel="noopener noreferrer">https://www.khaial.ai</a></li>
          ...
          <ul>
            <li>By email: <a href="mailto:info@khaial.ai">info@khaial.ai</a></li>
          </ul>
